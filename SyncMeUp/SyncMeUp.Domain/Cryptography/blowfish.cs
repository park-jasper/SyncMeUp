...
namespace SyncMeUp.Domain.Cryptography
{
    public class BlowFish
    {
        ...
        public BlowFish(string hexKey) : this(HexToByte(hexKey))
        {
        ...
        public byte[] Encrypt(byte[] plaintext) => Encrypt_CBC(plaintext);
        public string Encrypt(string plaintext) => Encrypt_CBC(plaintext);
        public byte[] Decrypt(byte[] ciphertext) => Decrypt_CBC(ciphertext);
        public string Decrypt(string ciphertext) => Decrypt_CBC(ciphertext);
        ...
        private string Encrypt_CBC(string pt)
        {
            if (!IVSet)
                SetRandomIV();
        ...
        private string Decrypt_CBC(string ct)
        {
        ...
        private string Encrypt_ECB(string pt)
        {
        ...
        private string Decrypt_ECB(string ct)
        {
        ...
        private void SetupKey(byte[] cipherKey)
        {
            ...
            if (cipherKey.Length > MaxKeyLength)
            {
